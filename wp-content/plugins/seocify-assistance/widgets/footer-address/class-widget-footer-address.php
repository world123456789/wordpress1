...
class Seocify_Footer_Address extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'Seocify_Footer_Address',
            'description'   => esc_html__('Seocify Footer Address','seocify')
        );
        
        parent::__construct('xs-footer-address', esc_html__('Seocify Footer Address', 'seocify'), $widget_opt);
    }
    ...
    function widget( $args, $instance ){
        ...
        <div class="media xs-footer-info-and-payment">
            ...
            <div class="media-body">
                ...
                <?php endif; ?>
                <?php if($map_btn != ''): ?>
                    <a href="https://maps.google.com/maps?<?php echo seocify_return($query_string);?>" class="xs-map-popup btn btn-primary">
                        <?php if($map_icon != ''): ?>
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Footer Address', 'seocify' );
        }
        if(isset($instance['message'])){
            $message = $instance['message'];
        }else{
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'message' )); ?>"><?php esc_html_e( 'Message' , 'seocify' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address:' , 'seocify' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_icon' )); ?>"><?php esc_html_e( 'Media Icon:' , 'seocify' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_icon' )); ?>"><?php esc_html_e( 'Map Icon:' , 'seocify' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_btn' )); ?>"><?php esc_html_e( 'Map Button:' , 'seocify' ); ?></label>
