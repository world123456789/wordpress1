		...
		jQuery(document).ready(function(){
			jQuery("#submit_iv_membership").on("click",function(){
						...
						if(valid == 1){
							...
							jQuery('#loading').html("<img src='<?php echo WP_iv_membership_URLPATH. 'admin/files/images/loader.gif'; ?>' />");
	...
	function save_the_form() {
		...
		var iv_client_email =		jQuery("#client-email").val(); 
				// New Block For Ajax*****
				var search_params={
					"action"  : 				"iv_membership_save_form",	
				...
				jQuery.ajax({					
					...
					success : function(response){
						...
						var url = "<?php echo WP_iv_membership_ADMINPATH; ?>admin.php?page=wp-iv_membership-from-all&form_submit=success";    						
					...
					<div class="row">
														...
														<label for="text" class="col-md-4 control-label">Form Width</label>
															...
															<div class="col-md-8">
																<div class=" ctrl-radiogroup">
																	<label class="radio"><input type="radio" name="iv_membership_width" value="Responsive" id="Responsive" checked />Responsive</label>
																	<label class="radio"><input type="radio" name="iv_membership_width"  id ="fixed_width" value="custom_width" /> Fixed Width
																	<input type="text"  id="iv_membership_width-input" name="iv_membership_width-input" class="form-control"  value="" placeholder="Enter Form Width  Like 500px" style="display: none" >	</label>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="col-md-8">
									<?php
									$iv_membership_auto_email_subject = get_bloginfo().': Contact Us';
									?>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="email-wrap" id="admin-template">
								...
								$content_admin = get_option('iv_membership_admin_email_green');
						...
						<div class="col-md-6 ">
							...
							<div class="col-md-12 email-wrap" id="client-template">
								...
								$content_client = get_option('iv_membership_client_email_green');
