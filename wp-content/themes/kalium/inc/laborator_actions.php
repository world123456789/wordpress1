...
function laborator_init() {
	...
	// Slick Carousel (soon to be deprecated)
	...
	// Flickity Carousel
    wp_register_style( 'flickity', kalium()->assetsUrl( 'js/flickity/flickity.min.css' ), null, $version );
    wp_register_script( 'flickity', kalium()->assetsUrl( 'js/flickity/flickity.pkgd.min.js' ), null, $version, true );

	// Flickity Fade Option
	wp_register_style( 'flickity-fade', kalium()->assetsUrl( 'js/flickity-fade/flickity-fade.css' ), null, $version );
	wp_register_script( 'flickity-fade', kalium()->assetsUrl( 'js/flickity-fade/flickity-fade.js' ), null, $version, true );
...
add_action( 'wp_footer', 'kalium_wp_footer', 10 );
